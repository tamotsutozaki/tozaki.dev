  ...
  return (
    <footer className="relative border-t border-line overflow-hidden" style={{ padding: "clamp(56px,9vh,110px) clamp(18px,5vw,72px) 38px" }}>
      <div className="mx-auto" style={{ maxWidth: 1240 }}>
        <div className="flex justify-between flex-wrap items-start gap-7" style={{ marginBottom: "clamp(40px,8vh,84px)" }}>
          <div>
            ...
            <a href="#contato" onClick={go("contato")} className="inline-flex items-center gap-2.5 font-bold text-fg cursor-pointer hover:gap-4 transition-all" style={{ fontSize: "clamp(1.4rem,3vw,2.1rem)", letterSpacing: "-0.03em" }}>
              {t.contact.heading} <span style={{ fontSize: "0.7em" }}>↗</span>
            </a>
          </div>
        </div>
